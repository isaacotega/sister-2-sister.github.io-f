$(document).ready(function() {
	...
	for(var i = 0; i < 10; i++) {
		...
		$("#shipmentsHolder").append(`
				
				<a onclick="window.location.href = 'shipment-details.html?id=123';">
				...
				<div class="shipment">
					...
					<label id="title">Shipment by <label id="shipperUsername">charlotte45</label>
					...
					<label id="location">
						...
						<label id="date">2nd April, 2023</label>
						
						<br>
					
						<span id="statusHolder" status="pending">
						...
						<label id="status">Pending Delivery</label>
